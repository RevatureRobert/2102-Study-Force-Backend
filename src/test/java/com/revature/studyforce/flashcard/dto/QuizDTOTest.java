...
/**
 * Test class for the QuizDTO {@link QuizDTO}
...
class QuizDTOTest {
    ...
    void givenQuiz_whenQuizToDTO_shouldReturnQuizDTO(){
        User user = new User(0, "mscott@dunder.com","Michael Scott",true,false,false, Authority.ROLE_USER, Timestamp.valueOf(LocalDateTime.now()),Timestamp.valueOf(LocalDateTime.now()));
