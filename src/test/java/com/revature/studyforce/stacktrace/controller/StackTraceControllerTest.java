...
class StackTraceControllerTest {
    ...
    void givenStacktrace_whenGetAll_thenStacktraceRetrieved() throws Exception {
        User u = userRepository.save(new User(1,"Test@mail.com","Test",true,true,true, Authority.USER,new Timestamp(0),new Timestamp(0)));
        Technology t = new Technology(2, "TestTech");
        stacktraceRepository.save(new Stacktrace(1,
                new User(1,"Test@mail.com","Test",true,true,true, Authority.USER,new Timestamp(0),new Timestamp(0)),
